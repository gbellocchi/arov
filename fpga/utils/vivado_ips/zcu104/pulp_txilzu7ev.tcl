...
add_files -norecurse -fileset [current_fileset] ./pulp_txilzu7ev.v
source ./define_defines_includes.tcl
add_files -norecurse -fileset constrs_1 {./pulp_txilzu7ev_synth.xdc ./pulp_txilzu7ev_impl.xdc}
set_property used_in_implementation false [get_files ./pulp_txilzu7ev_synth.xdc]
set_property used_in_synthesis false [get_files ./pulp_txilzu7ev_impl.xdc]
set_property top pulp_txilzu7ev [current_fileset]
