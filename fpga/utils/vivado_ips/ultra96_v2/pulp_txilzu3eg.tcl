...
add_files -norecurse -fileset [current_fileset] ./pulp_txilzu3eg.v
source ./define_defines_includes.tcl
add_files -norecurse -fileset constrs_1 {./pulp_txilzu3eg_synth.xdc ./pulp_txilzu3eg_impl.xdc}
set_property used_in_implementation false [get_files ./pulp_txilzu3eg_synth.xdc]
set_property used_in_synthesis false [get_files ./pulp_txilzu3eg_impl.xdc]
set_property top pulp_txilzu3eg [current_fileset]
