...
create_project hero_exilzcu104 ${prj_dir} -part xczu7ev-ffvc1156-2-e
set_property board_part xilinx.com:zcu104:part0:1.1 [current_project]
set_property ip_repo_paths ${vivado_ips} [current_project]
update_ip_catalog

create_bd_design "hero_exilzcu104"
...
# PULP
create_bd_cell -type ip -vlnv ethz.ch:user:pulp_txilzu7ev:1.0 i_pulp
...
make_wrapper -files [get_files \
  ${prj_dir}/hero_exilzcu104.srcs/sources_1/bd/hero_exilzcu104/hero_exilzcu104.bd \
] -top
add_files -norecurse \
  ${prj_dir}/hero_exilzcu104.srcs/sources_1/bd/hero_exilzcu104/hdl/hero_exilzcu104_wrapper.v

# Create targets and runs for IPs.
generate_target all \
  [get_files ${prj_dir}/hero_exilzcu104.srcs/sources_1/bd/hero_exilzcu104/hero_exilzcu104.bd]
...
export_ip_user_files -of_objects [get_ips hero_exilzcu104_i_pulp_0] \
  -no_script -sync -force -quiet

# Define include and defines again for PULP.
eval [exec sed {s/current_fileset/get_filesets hero_exilzcu104_i_pulp_0/} \
  ${vivado_ips}/define_defines_includes_no_simset.tcl]

# Include debug settings.
# add_files -fileset constrs_1 ./utils/hero_exilzcu104_debug.xdc
# set_property target_constrs_file ./utils/hero_exilzcu104_debug.xdc [current_fileset -constrset]

# Synthesize
foreach run [list synth_1 hero_exilzcu104_i_pulp_0_synth_1] {
