...
create_project hero_exilultra96_v2 ${prj_dir} -part xczu3eg-sbva484-1-e
set_property board_part em.avnet.com:ultra96v2:part0:1.0 [current_project]
set_property ip_repo_paths ${vivado_ips} [current_project]
update_ip_catalog

create_bd_design "hero_exilultra96_v2"
...
make_wrapper -files [get_files \
  ${prj_dir}/hero_exilultra96_v2.srcs/sources_1/bd/hero_exilultra96_v2/hero_exilultra96_v2.bd \
] -top
add_files -norecurse \
  ${prj_dir}/hero_exilultra96_v2.srcs/sources_1/bd/hero_exilultra96_v2/hdl/hero_exilultra96_v2_wrapper.v

# Create targets and runs for IPs.
generate_target all \
  [get_files ${prj_dir}/hero_exilultra96_v2.srcs/sources_1/bd/hero_exilultra96_v2/hero_exilultra96_v2.bd]
...
export_ip_user_files -of_objects [get_ips hero_exilultra96_v2_i_pulp_0] \
  -no_script -sync -force -quiet

# Define include and defines again for PULP.
eval [exec sed {s/current_fileset/get_filesets hero_exilultra96_v2_i_pulp_0/} \
  ${vivado_ips}/define_defines_includes_no_simset.tcl]

# Include debug settings.
# add_files -fileset constrs_1 ./utils/hero_exilultra96_v2_debug.xdc
# set_property target_constrs_file ./utils/hero_exilultra96_v2_debug.xdc [current_fileset -constrset]

# Synthesize
foreach run [list synth_1 hero_exilultra96_v2_i_pulp_0_synth_1] {
